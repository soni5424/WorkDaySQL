...
where waittime > 5000 -- 5 detik
	...
	and (TableName = 'h_SAP_PromoServToMyHartono' or TableName = '')
...
WHERE OBJECT_NAME(P.object_id) LIKE '%h_SAP_PromoServToMyHartono%'-- OR OBJECT_NAME(P.object_id) LIKE '%TrxSO%'
