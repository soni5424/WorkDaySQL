...
/****** Object:  StoredProcedure [dbo].[PGetOpnameKurang]    Script Date: 07/08/2020 14.00.49 ******/
SET ANSI_NULLS ON
GO
...
ALTER PROCEDURE [dbo].[PGetOpnameKurang]
    @PID varchar(50)
as
BEGIN
	...
	where coalesce(Unrestricted,0)+coalesce(Blocked,0)>coalesce(qtyfisik,0)
		and xxxx.article is not null and xxxx.article != '' -- MM15.005.6.B 
