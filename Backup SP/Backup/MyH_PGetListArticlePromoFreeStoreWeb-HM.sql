...
/****** Object:  StoredProcedure [dbo].[MyH_PGetListArticlePromoFreeStoreWeb]    Script Date: 22/04/2020 12.07.03 ******/
SET ANSI_NULLS ON
GO
...
-- Description	: Get List Promo Free Untuk Web per Store
-- =============================================
ALTER PROCEDURE [dbo].[MyH_PGetListArticlePromoFreeStoreWeb]
	@jenis		varchar(50),
...
BEGIN
	...
	*/
	...
	inner join (
		...
		p.Status, pbu.KodeBarang KodeBarangUtama, pbu.Jumlah QtyBarangUtama, pbf.KodeBarangFree, pbf.JumlahBarangFree QtyBarangFree,
		pbf.PotonganVPR, pbf.JenisNilai 
		from 
		PR_MasterPromo p,
