...
/****** Object:  StoredProcedure [dbo].[VTI_CheckNoVoucher]    Script Date: 28/05/2020 14.37.43 ******/
SET ANSI_NULLS ON
GO
...
-- Modified By:	|Rio|
-- Modify date: |07/04/2020|
-- ModifiedDesc:|Hilangkan pengecekan Tidak Dapat Dipindahtangankan|
-- =============================================
ALTER PROCEDURE [dbo].[VTI_CheckNoVoucher]
