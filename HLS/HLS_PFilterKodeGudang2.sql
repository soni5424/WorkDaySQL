...
/****** Object:  StoredProcedure [dbo].[HLS_PFilterKodeGudang]    Script Date: 03/30/2021 08:57:53 ******/
SET ANSI_NULLS ON
GO
...
WHERE 
	...
	--a.tanggal >= CONVERT(VARCHAR(10),GETDATE(),111) --27/04/2020
	--Start Daniel 11/06/2020 Connect SO HLS Inquiry SO SD19-007
--	(		
	...
	(
		...
		or
		(a.idcounter != @ParameterRoute and isnull(b.kodegudang, '') NOT IN (SELECT kodegudang FROM mastergudang WHERE display = '1'))
	)
